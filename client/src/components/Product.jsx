  ...
  return (
    <div className="productCard flex flex-col gap-6 items-center pb-6 shadow-md sm:shadow-none">
        ...
        <div className="productImgContents overflow-hidden lg:min-h-80 ">
            ...
            <h5 className="absolute bottom-0 w-full bg-neutral-600 text-white h-9 pt-1 opacity-0 transition-opacity duration-300 ease-in-out " onClick={handleQuickView}>Quick View</h5>
        </div>
